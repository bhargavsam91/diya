...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
        "Dear Cuto..",
        canvas.width / 2,
        canvas.height / 2 - 20  // Adjust Y coordinate to position the first line
    );
    
    context.fillText(
        "Everyday I cannot believe how lucky I am",
        canvas.width / 2,
        canvas.height / 2 + 20  // Adjust Y coordinate to position the second line
    );
...
if (frameNumber < 300) {
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    ...
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "I am reminded of the joy you bring",
      canvas.width / 2,
      canvas.height / 2+20
    );
